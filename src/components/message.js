...
export function arePropsEqual(props, nextProps) {
  const {values} = props;
  ...
  return shallowEquals(props, nextPropsToCheck);
}

function FormattedMessage(props) {
  const {formatMessage = defaultFormatMessage, textComponent: Text = 'span'} =
    useIntl({enforceContext: !props.defaultMessage}) || {};
...
export default React.memo(FormattedMessage, arePropsEqual);
