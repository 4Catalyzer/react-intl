...
describe('format API', () => {
  ...
  beforeEach(() => {
    ...
    state = {
      getDateTimeFormat: jest.fn((...args) => new Intl.DateTimeFormat(...args)),
      getNumberFormat: jest.fn((...args) => new Intl.NumberFormat(...args)),
      getMessageFormat: jest.fn((...args) => new IntlMessageFormat(...args)),
      getRelativeFormat: jest.fn((...args) => new IntlRelativeFormat(...args)),
      getPluralFormat: jest.fn((...args) => new IntlPluralFormat(...args)),
  ...
  describe('formatRelative()', () => {
    ...
    describe('options', () => {
      ...
      it('falls back and warns on invalid IntlRelativeFormat options', () => {
        expect(formatRelative(0, { units: 'invalid' })).toBe(
          String(new Date(0))
        )
        expect(consoleError).toHaveBeenCalledTimes(1)
        expect(
          consoleError.mock.calls[0][0].startsWith(
